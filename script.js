document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectData = {
        ...
        'photo-editor': {
            ...
            desc: '**Problem:** I needed a lightweight way to make quick image adjustments without heavy software. **Solution:** Built a browser-based photo editor that supports common editing actions with a clean interface and responsive controls.',
            repo: 'https://github.com/NoumanSyed70/luminous-editor',
            demo: 'https://noumansyed70.github.io/luminous-editor/' // LIVE DEMO ENABLED
        },
        'ai-decision-simulator': {
            ...
            repo: 'https://github.com/NoumanSyed70/AI-Decision_Simulator',
            demo: null // LIVE DEMO DISABLED
        }
    };
    ...
    function updateSlider() {
        ...
        const offset = -(currentIndex * getSlideStride());
